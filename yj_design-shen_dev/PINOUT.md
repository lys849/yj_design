...
| VGA_B[0..3] | | B7, C7, D7, D8 | → | LVCMOS33 |
| VGA_HSYNC | `vga_hsync` | B11 | → | LVCMOS33 |
| VGA_VSYNC | `vga_vsync` | B12 | → | LVCMOS33 |
...
|-----------|------|-----------|--------|
| JB1 | `kb_row[0]` | D14 | 键盘行 1 |
| JB2 | `kb_row[1]` | F16 | 键盘行 2 |
| JB3 | `kb_row[2]` | G16 | 键盘行 3 |
| JB4 | `kb_row[3]` | H14 | 键盘行 4 |
| JB7 | `kb_col[0]` | E16 | 键盘列 1 |
| JB8 | `kb_col[1]` | F13 | 键盘列 2 |
| JB9 | `kb_col[2]` | G13 | 键盘列 3 |
| JB10 | `kb_col[3]` | H16 | 键盘列 4 |
