# Complete system Block Design: MicroBlaze + UART Lite + fp_payment_periph.

set old_bd [get_files -quiet system_bd.bd]
if {[llength $old_bd] > 0} {
    catch {close_bd_design system_bd}
    remove_files $old_bd
...
# Use the Nexys4 DDR single-ended 100 MHz clock input.
...
# CPU_RESET on Nexys4 DDR is active-low.
...
# ---- Debug UART over the onboard USB-UART bridge ----
...
# ---- Custom all-peripheral AXI-Lite IP ----
...
connect_bd_net [get_bd_ports btnc] [get_bd_pins fp_periph_0/btnc]
connect_bd_net [get_bd_ports btnd] [get_bd_pins fp_periph_0/btnd]
...
connect_bd_net [get_bd_pins fp_periph_0/led] [get_bd_ports led]

create_bd_port -dir O -from 10 -to 0 vga_char_addr
create_bd_port -dir O -from 7 -to 0 vga_char_data
create_bd_port -dir O vga_char_we_toggle
connect_bd_net [get_bd_pins fp_periph_0/vga_char_addr] [get_bd_ports vga_char_addr]
connect_bd_net [get_bd_pins fp_periph_0/vga_char_data] [get_bd_ports vga_char_data]
connect_bd_net [get_bd_pins fp_periph_0/vga_char_we_toggle] [get_bd_ports vga_char_we_toggle]
...
set wrapper_file [glob -nocomplain \
    $proj_dir/*.gen/sources_1/bd/system_bd/hdl/system_bd_wrapper.v \
    $proj_dir/*.srcs/sources_1/bd/system_bd/hdl/system_bd_wrapper.v]
if {$wrapper_file ne ""} {
    add_files -norecurse [lindex $wrapper_file 0]
    update_compile_order -fileset sources_1
}

puts "Complete system Block Design generated."
